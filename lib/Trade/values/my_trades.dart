...
class MyTrades extends ValueNotifier<List<TradeModel>> {
  factory MyTrades() => _shared;
  MyTrades._sharedInstance() : super([]);
  static final MyTrades _shared = MyTrades._sharedInstance();
